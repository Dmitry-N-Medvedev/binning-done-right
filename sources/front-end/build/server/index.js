import { r as render, d as define_property, o as object_keys, p as push$1, c as current_component_context, a as pop$1, b as render_effect, e as array_from, f as destroy_signal, g as push, h as copy_payload, i as assign_payload, j as bind_props, k as pop, s as source, l as is_array, m as set, u as update, n as effect_active, q as updating_derived, t as get_descriptor, v as mutable_source, w as get, U as UNINITIALIZED, x as object_assign, y as flushSync, z as create_anchor } from './chunks/index-q-XdH9cF.js';
import { s as setContext } from './chunks/main-client-t9EFTmDH.js';
  ...
  if (typeof value === "object" && value != null && !is_frozen(value)) {
    ...
    if (prototype === object_prototype || prototype === array_prototype) {
      ...
      define_property(value, STATE_SYMBOL, {
        value: init$1(value, proxy2, immutable),
        writable: false
      });
      return proxy2;
    }
...
function init$1(value, proxy2, immutable) {
  return {
    s: /* @__PURE__ */ new Map(),
    v: source(0),
    a: is_array(value),
...
const options = {
  ...
  templates: {
    app: ({ head, body, assets: assets2, nonce, env }) => '<!doctype html>\n<html lang="en">\n	<head>\n		<meta charset="utf-8" />\n    <link rel="manifest" href="' + assets2 + '/manifest.webmanifest" crossorigin="use-credentials" />\n    <link rel="stylesheet" href="' + assets2 + '/themes/corp/theme.css" />\n    <link rel="stylesheet" href="' + assets2 + '/global.css" />\n		<link rel="icon" href="' + assets2 + '/favicon.png" />\n		<meta name="viewport" content="width=device-width, initial-scale=1" />\n		' + head + '\n	</head>\n	<body data-sveltekit-preload-data="hover">\n    <div style="display: contents;">\n		  ' + body + "\n    </div>\n	</body>\n</html>",
  ...
  version_hash: "16v1fwy"
};
async function get_hooks() {
  return {
    ...await import('./chunks/hooks.server-j4vP0_-v.js')
  };
}
